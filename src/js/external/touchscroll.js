  ...
  var module = {
    ...
    init: function(options) {
      ...
      if (options.draggable === true) {
        ...
        this.addEvent('mouseleave', this.el, function(e) {
          me.onMouseUp(e);
        });
      }
    ...
    onMouseDown: function(e) {
      if (this.drag === false || this.options.wait === false) {
        ...
        this.diffy = 0;
        this.scale =
          this.fullWidth / this.$pageContainer[0].getBoundingClientRect().width;
    ...
    onMouseMove: function(e) {
      if (this.drag === true) {
        ...
        this.el.scrollLeft += this.diffx / this.scale;
        this.el.scrollTop += this.diffy / this.scale;
        this.lastMove = e.timeStamp;
      }
    },
    /**
    ...
    onMouseUp: function(e) {
      if (this.drag === true) {
        ...
        var me = this,
          start = 1;
        if (e.timeStamp - this.lastMove <= 100) {
          this.animate = function() {
            ...
            if (step <= 0) {
              ...
              this.el.scrollTop += this.diffy * step;
              start -= this.time;
              if (this.animate) {
