        ...
        c = (function(e) {
          ...
          return (
            ...
            (t.prototype.draw = function() {
              ...
              var p = r - h,
                u = r + h;
              (c += o.lineTo({ x: a + i * l.cos(p), y: s + i * l.sin(p) })),
                (c += o.arcToPoint(
                  { x: a + i * l.cos(u), y: s + i * l.sin(u) },
                  n,
                  n,
                  !0,
                  !0
            ...
            (t.prototype.getTooltipY = function() {
              return (
                l.sin(this.pointerAngle) *
                  (0.8 * -this.pointerLength - this.radius) -
                this.radius
              );
            }),
            (t.prototype.getTooltipX = function() {
              return (
                l.cos(this.pointerAngle) *
                (0.8 * -this.pointerLength - this.radius)
              );
            }),
            t
      ...
      var h = i('TXRX'),
        ...
        g = (function(e) {
          function t() {
            ...
            (r.shouldClone = !1),
              (r.isMeasured = !1),
              (r.fill = i.getFor('background')),
              (r.radius = Object(u.c)(85)),
              (t.circle = r);
            var n = t.background;
            return (
              (n.fill = i.getFor('alternativeBackground')),
              (n.fillOpacity = 1),
              (n.pointerBaseWidth = 20),
              (n.pointerLength = 20),
              (n.radius = 25),
              n.events.on('propertychanged', t.invalidate, t, !1),
              t.applyTheme(),
              t
            );
          }
          return (
            ...
            (t.prototype.validate = function() {
              ...
              var h = s - c,
                p = s + c,
                d = { x: i + n * l.cos(h), y: r + n * l.sin(h) },
                g = { x: i + n * l.cos(p), y: r + n * l.sin(p) },
                y = d.x,
                f = g.x,
                b = d.y,
                m = g.y,
                ...
                x =
                  (y + f) / 2 -
                  Math.sqrt(v - (P / 2) * (P / 2)) * ((b - m) / P),
                C =
                  (b + m) / 2 -
                  Math.sqrt(v - (P / 2) * (P / 2)) * ((f - y) / P);
              this.circle &&
                this.circle.radius instanceof u.a &&
                ((this.circle.width = 2 * o), (this.circle.height = 2 * o));
              var O = this.image;
              O
                ? ((O.x = x),
                  (O.y = C),
                  (O.width = 2 * o),
                  (O.height = 2 * o),
                  O.element.attr({ preserveAspectRatio: 'xMidYMid slice' }),
                  this.circle && (this.circle.scale = 1 / O.scale))
                : this.circle && ((this.circle.x = x), (this.circle.y = C));
              var V = this.label;
              V && ((V.x = x), (V.y = C));
            }),
            Object.defineProperty(t.prototype, 'image', {
              ...
              set: function(e) {
                e &&
                  ...
                  this.circle && (e.mask = this.circle));
              },
              enumerable: !0,
              configurable: !0
            }),
            ...
            (t.prototype.copyFrom = function(t) {
              e.prototype.copyFrom.call(this, t),
                t.image &&
                  (this._image || (this.image = t.image.clone()),
                  this._image.copyFrom(t.image)),
                this.circle && t.circle && this.circle.copyFrom(t.circle),
                t.label &&
                  (this._label || (this.label = t.label.clone()),
                  this._label.copyFrom(t.label));
            }),
      ...
      var y = i('p9TX'),
        ...
        m = (function(e) {
          function t() {
            ...
            var i = t.background;
            (i.fillOpacity = 1),
              i.events.on('propertychanged', t.invalidate, t, !1),
              (i.waveHeight = 1.5),
              (i.waveLength = 7),
              i.setWavedSides(!0, !1, !0, !1),
              (i.strokeOpacity = 1);
            var r = new d.a();
            (t.stroke = r.getFor('alternativeBackground')),
              (t.pole = t.createChild(b.a)),
              (t.pole.strokeOpacity = 1),
              (t.width = 22),
              (t.height = 16);
            var n = new y.a();
            return (
              ...
              (n.dy = 1),
              n.events.on('propertychanged', t.invalidate, t, !1),
              n.events.on('positionchanged', t.invalidate, t, !1),
              (n.strokeOpacity = 0),
              (t.label = n),
              (t.poleHeight = 10),
              t.applyTheme(),
          ...
          return (
            ...
            (t.prototype.validate = function() {
              ...
              var i = this.poleHeight,
                ...
                n = t.pixelHeight;
              i > 0
                ? ((this.pole.y2 = -i - n), r && (r.y = -i - n))
                : ((this.pole.y2 = -i + n), r && (r.y = -i)),
                r && 'middle' == r.horizontalCenter && (this.pole.y2 = -i);
            }),
            (t.prototype.updateBackground = function() {
              ...
              if (e) {
                ...
                t
                  ? ((e.x = t.maxLeft),
                    (e.width = t.measuredWidth),
                    (e.height = t.measuredHeight))
                  : ((e.width = Math.abs(this.maxRight - this.maxLeft)),
                    (e.height = Math.abs(this.maxBottom - this.maxTop)));
                var i = this.poleHeight;
            ...
            (t.prototype.copyFrom = function(t) {
              t.label && (this.label = t.label.clone()),
                t.pole && this.pole.copyFrom(t.pole),
                e.prototype.copyFrom.call(this, t);
            }),
            (t.prototype.createBackground = function() {
              return new f.a();
        ...
        C = (function(e) {
          function t() {
            ...
            return (
              ...
              (t.arc = 360),
              (t.radius = 100),
              (t.innerRadius = Object(u.c)(30)),
              (t.cornerRadius = 0),
              (t.innerCornerRadius = 0),
              (t.startAngle = -90),
              (t.element = t.paper.add('path')),
              t.applyTheme(),
              t
          ...
          return (
            ...
            (t.prototype.draw = function() {
              ...
              for (var h = i / r / 2, p = '', u = 0; u < r; u++) {
                var d = t + (u * i) / r;
                if (s > 0) {
                  var g = { x: a * l.cos(d - h), y: a * l.sin(d - h) },
                    y = { x: n * l.cos(d), y: n * l.sin(d) },
                    f = { x: a * l.cos(d + h), y: a * l.sin(d + h) },
                    b = l.getAngle(y, g),
                    m = l.getAngle(y, f),
                    v = y.x + s * l.cos(b),
                    P = y.y + s * l.sin(b),
                ...
                if (((d += h), c > 0)) {
                  (g = { x: n * l.cos(d - h), y: n * l.sin(d - h) }),
                    (y = { x: a * l.cos(d), y: a * l.sin(d) }),
                    (f = { x: n * l.cos(d + h), y: n * l.sin(d + h) }),
                    (b = l.getAngle(y, g)),
                    (m = l.getAngle(y, f)),
                    (v = y.x + c * l.cos(b)),
                    (P = y.y + c * l.sin(b)),
              ...
              this.arc < 360 && (p += o.lineTo({ x: 0, y: 0 })),
                (p = (p += o.closePath()).replace('L', 'M')),
                (this.path = p);
            }),
      ...
      var O = i('GtDR'),
        ...
        w = (function(e) {
          function t() {
            var t = e.call(this) || this;
            return (
              (t.className = 'ShapeBullet'), (t.size = 10), t.applyTheme(), t
            );
          }
          return (
            Object(n.c)(t, e),
            (t.prototype.draw = function() {
              switch (
                (e.prototype.draw.call(this),
                this.shapeElement && this.shapeElement.dispose(),
                this.shape)
              ) {
                case 'square':
                  this.createSquare();
            ...
            Object.defineProperty(t.prototype, 'size', {
              ...
              set: function(e) {
                this.setPropertyValue('size', e, !0) &&
                  ((this.width = e), (this.height = e), this.invalidate());
              },
              enumerable: !0,
              configurable: !0
            }),
