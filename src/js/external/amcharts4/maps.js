    ...
    QJ7E: function(t, e, n) {
      ...
      var J,
        ...
        rt = {
          ...
          polygonEnd: function() {
            var t = +nt;
            it.add(t < 0 ? O + t : t),
              (this.lineStart = this.lineEnd = this.point = W);
          },
          sphere: function() {
            it.add(O);
          }
      ...
      function _e(t, e, n, i, r, o) {
        if (n) {
          ...
          for (var c, l = r; i > 0 ? l > o : l < o; l -= s)
            (c = lt([a, -u * T(l), -u * V(l)])), t.point(c[0], c[1]);
        }
      }
      function Me(t, e) {
        ((e = ht(e))[0] -= t), vt(e);
        ...
        return function(a) {
          ...
          function M(o, a) {
            ...
            if ((c && l.push([o, a]), m))
              ...
              var s = [
                  (d = Math.max(Ze, Math.min(We, d))),
                  (g = Math.max(Ze, Math.min(We, g)))
                ],
                P = [
                  (o = Math.max(Ze, Math.min(We, o))),
                  (a = Math.max(Ze, Math.min(We, a)))
                ];
              He(s, P, t, e, n, i)
      ...
      var Pn,
        ...
        Ln = {
          ...
          polygonEnd: function() {
            (Ln.lineStart = Ln.lineEnd = Ln.point = W),
              On.add(C(wn)),
              wn.reset();
          },
          result: function() {
          ...
          Object.defineProperty(e.prototype, 'latitude', {
            get: function() {
              ...
              return (
                !g.isNumber(t) &&
                  this.dataItem &&
                  this.dataItem.geoPoint &&
                  (t = this.dataItem.geoPoint.latitude),
                t
              );
            },
            set: function(t) {
            ...
            get: function() {
              ...
              return (
                !g.isNumber(t) &&
                  this.dataItem &&
                  this.dataItem.geoPoint &&
                  (t = this.dataItem.geoPoint.longitude),
                t
              );
            },
            set: function(t) {
            ...
            Object.defineProperty(e.prototype, 'mapPolygons', {
              get: function() {
                if (!this._mapPolygons) {
                  var t = new Hr(),
                    e = new Wr.e(t);
                  this._disposers.push(new Wr.c(e)),
          ...
          return (
            ...
            Object.defineProperty(e.prototype, 'lineObjects', {
              get: function() {
                return (
                  this._lineObjects ||
                    ((this._lineObjects = new Wr.e(new ao())),
                    ...
                    this._disposers.push(new Wr.c(this._lineObjects)),
        ...
        So = (function(t) {
                ...
                Object(bo.b)().body.events.on(
                  ...
                  function(t) {
                    if (e.topParent.hasFocused) {
                      var n = to.b.getEventKey(t.event);
                      if (
                        'enter' == n &&
                        e.topParent.focusedElement &&
                        e.topParent.focusedElement.events.has('hit')
                      )
                        e.topParent.focusedElement.dispatchImmediately('hit');
                      else if (
                        !e._zoomControl ||
                        !e._zoomControl.thumb.isFocused
                      )
                        switch (n) {
                          case 'up':
                            e.pan({ x: 0, y: 0.1 });
          ...
          return (
              ...
              if (t && g.isNumber(t.longitude) && g.isNumber(t.latitude)) {
                ...
                if (u) {
                  var s = this.geoPointToSVG(t),
                    c = Zr.svgPointToSprite(s, this);
                  n &&
                    (c = { x: this.innerWidth / 2, y: this.innerHeight / 2 }),
            ...
            (e.prototype.zoomToRectangle = function(t, e, n, i, r, o, a) {
              ...
              i < c &&
                e > c &&
                ((l += 180), (h = v.normalizeAngle(e - i - 360)));
              var p =
                r *
                Math.min(
                  (this.south - this.north) / (n - t),
                  Math.abs((this.west - this.east) / h)
                );
              return this.zoomToGeoPoint(
                { latitude: t + (n - t) / 2, longitude: l },
                p,
                o,
                a,
                !0
      ...
      la.invert = function(t, e) {
        ...
        var n = 1 + t * t + e * e,
          ...
          s = u * u - a * a;
        return [
          2 * Wo(t) * zo(ua(o) * a, 0.25 - s),
          2 * Wo(e) * zo(u * Zo(r), 0.25 + s)
        ];
      };
      var ha = aa(8),
        pa = Ro(1 + $o);
      ...
      bu.invert = function(t, e) {
        ...
        return (
          (a = qo(r)),
          [
            (Do(e) < Do(r + 1 / a) ? ra(t * a) : Wo(t) * (oa(Do(t * a)) + Jo)) /
              Zo(r),
            r
          ]
        );
      ...
      function Ou(t, e) {
        ...
        var r = Vo(i),
          ...
          p = a + u;
        return [
          (Wo(t) * Uo * (o * h + aa(a * h * h - l * (u * u - c)))) / l,
          (Wo(e) * Uo * (s * p - o * aa((a + 1) * l - p * p))) / l
        ];
      }
      Ou.invert = function(t, e) {
        if (Do(e) < Xo) return [t, 0];
